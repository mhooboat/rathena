...
extern short current_charm_index;
...
class NoEquipDatabase : public TypesafeYamlDatabase<uint16, s_no_equip>{
public:
	NoEquipDatabase() : TypesafeYamlDatabase( "NO_EQUIP_DB", 1 ){
...
extern NoEquipDatabase no_equip_db;
